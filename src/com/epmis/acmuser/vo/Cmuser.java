...
public class Cmuser {
	  ...
	  private String userpic;//图片 hxl
	  private String issub;//是否被附属 hxl
	  private String subsidiary;//附属 hxl
