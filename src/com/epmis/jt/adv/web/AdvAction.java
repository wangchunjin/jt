...
public class AdvAction extends ActionSupport implements ServletRequestAware{
	...
	public void findAllAdv(){
		...
		List<Map<String, Object>> result = this.advService.findAllAdv(isdel,page,rows);
...
//				System.out.println(map.get("url"));
		...
		int count=this.advService.count(isdel);
...
//		WriterJsonArray.writerJSONArray(result, response);
	...
	public void delete(){
		...
		for(int i=0;i<stringArr.length;i++){
			result = this.advService.delete(stringArr[i]);
		}
	 ...
	 */
	public void wz(){
		String result = this.advService.wz(adv);
	...
	public void save() throws Exception{
		...
		adv.setPic(this.execute(file));
		String result =advService.save(adv);
		WriterJsonArray.writerJSONArray(result, response);
	}
	...
	public String findById(){
		...
		String sss="success";
		List<Map<String, Object>> result = this.advService.findById(id);
		request.setAttribute("adv", result);
	...
	public void update() throws Exception{
		adv.setPic(this.execute(file));
		String result = this.advService.update(adv);
		WriterJsonArray.writerJSONArray(result, response);
