package com.epmis.jt.raiders.web;
...
public class RaidersAction extends ActionSupport implements ServletRequestAware{
	...
	public void findAllRaiders(){
	
		String isdel = request.getParameter("isdel");	
		
		List<Map<String, Object>> result = this.raidersService.findAllRaiders(isdel,page,rows);
...
//				System.out.println(map.get("url"));
		...
		int count=this.raidersService.count(isdel);
...
//		WriterJsonArray.writerJSONArray(result, response);
	...
	public void delete(){
		...
		for(int i=0;i<stringArr.length;i++){
			result = this.raidersService.delete(stringArr[i]);
		}
	 ...
	 */
	public void wz(){
		String result = this.raidersService.wz(raiders);
	...
	public void save() throws Exception{
		...
		raiders.setPic(this.execute(file));
		String result =raidersService.save(raiders);
		WriterJsonArray.writerJSONArray(result, response);
	}
	...
	public String findById(){
		...
		String sss="success";
		List<Map<String, Object>> result = this.raidersService.findById(id);
		request.setAttribute("raiders", result);
	...
	public void update() throws Exception{
		raiders.setPic(this.execute(file));
		String result = this.raidersService.update(raiders);
		WriterJsonArray.writerJSONArray(result, response);
