...
public class JiguangPush_yonghu {
    ...
    {  
   	 JPushClient jpushClient = new JPushClient("18f6d0e4c70fdc9a9e40edd3","769b800e0a25f419ae1b976e");  
//         
//        Map<String, String> extras = new HashMap<String, String>();  
//        // 添加附加信息  
//        extras.put("extMessage", "我是额外的消息--sendAlias");  
  
        PushPayload payload = allPlatformAndAlias(message, aliasList);  
        try  
        {
    ...
    /** 
     * 极光推送：生成向一个或者一组用户发送的消息。  部分推送 tag为20一组 alias为1000一组
     */  
...
//    	 aliasList.add("15150628009");
//    	 aliasList.add("13554281768");
//    	 Map<String,String> map=new Hashtable();
//    	 map.put("extMessage", "南京");
//    	 sendAlias("针对部分人测试qq", map,aliasList); 
    	 
    	 Timer timer=new Timer();    	 
    	 timer.scheduleAtFixedRate(new TimerTask() {			
			@Override
			public void run() {
				String id=UUID.randomUUID().toString().replace("-", "");//生成的id942cd30b-16c8-449e-8dc5-028f38495bb5中间含有横杠，<span style="color: rgb(75, 75, 75); font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 20.7999992370605px;">用来生成数据库的主键id是很实用的。</span> 		    	 
