...
public class JiguangPush1 {
     ...
     * 极光推送
     */
    public static void jiguangPush(String alias,String alert,String title,String type){
        try{
...
//    	 String title="title222222";//点击事件ID
//    	 jiguangPush(alias,alert,title,"1");
    	 int a=2;
    	 int b=a/20;
