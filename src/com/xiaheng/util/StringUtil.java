...
public final class StringUtil {
	 ...
	 * 
	 * @param lineLen
	 *            the length of the substrings to separate with spaces.
	 * @param original
	 *            the original String
	 * 
	...
	/**
	 * Replace all the occurences of HTML escape strings with the respective
	 * characters.
	 * 
	 * @param s
			...
			if (j < chars.length && chars[j] == ';') {
				if (s.charAt(i + 1) == '#') { // Check for &#D; and &#xD;
					...
					try {
						...
						if (ch == 'x' || ch == 'X') {
							charcode = Long.parseLong(new String(chars, i + 3,
									j - i - 3), 16);
						} else if (Character.isDigit(ch)) {
							charcode = Long.parseLong(new String(chars, i + 2,
									j - i - 2));
						}
	 ...
	 * This is essentially similar to the {@link javaEscape(java.lang.String)}
	 ...
	 * 
	 * @param in
	 *            The delimited input string to process
	 * @param delimiter
	 *            The string delimiting entries in the input string.
	 * @param doString
	 ...
	 * 
	 * @param in
	 *            - the collection that has to be conatenated
	 * @param separator
	 ...
	 * @param sepKey
	 *            - the separator to put between key and value
	 * @param sepEntry
	 ...
	 * @throws IllegalArgumentException
	 *             if the map contains duplicate string keys after lower casing
	 */
	 ...
	 *            the string you want to munge
	 * @param chars
	 *            all of the characters to be considered for munge
	 * @param replacement
	 ...
	 *            input stream
	 * @param maxLength
	 *            max number of bytes to read from "is". If this is -1, we read
	 *            everything.
	 * 
	 ...
	 * 
	 * @param list
	 *            String containing delimited substrings
	 * @param delimiter
	...
	/**
	 * @param dbSpecComponent
	 *            a single component of a DBDescriptor spec (e.g. the host or
	...
	public static void main(String[] args) {
		...
		content.append("	&nbsp;</div>\n");
		content.append("<div>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		Shanghai K&amp;G has attended&nbsp;the sixth edition of Tubotech - International Fair of pipes, fittings and components and TERMOTECH III - Thermal Technologies Industrial Fair, held between 4th and 6th October at the Center for Exhibitionss immigrants in S&atilde;o Paulo.</p>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		While being held Metal Tech - IV Industrial Technology Fair in Metals, Wicab - International Wire and Cable Fair, Petrotech - Brazilian Fair of technologies for the Oil Industry, Gas and Biofuels Expo Pumps - II International Fair Pumps, Motor Pumps &amp; Fittings, Valves Expo, II d International Fair Industrial Valves &amp; Fittings, the Feige II Gas Industrial Fair, the Fluid Power &amp; Motion Control and Febraman, Brazilian Fair Maintenance.</p>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		<img alt=\"\" src=\"http://kangguang.site-web.cn/uploadedImage/2014132811135957495_big.jpg\" style=\"width: 335px; height: 251px;\" /></p>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		Organized by Grupo Cipa Milano Fair, the event expects to receive integrated 18 000 visitors, with an expectation that business is around \\$ 800 million. The number of exhibitors grew by 73% compared to 2009 and this edition also features a 120% growth in the area dedicated to the foreign participants. Participating countries also showed an increase of 70%. They are 450 international and 250 national companies.</p>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		Attended the official opening Voswinckel Gunter, president of the ITA (International Tube Association); Wienkamp Erhard, director of the Division Messe Dusseldorf;Roberto Foresti, commercial director of Fiera Milano, Francesco Santa, international director of Fiera Milano, Kurt G. Eder, president of the Austrian Wire Cable Machinery Association (AWCMA) and vice president of the International Wire &amp; Cable Exhibitors Association (IWCEA) Eloi Fernandez y Fernandez, director general of the National Organization of the Petroleum Industry (ONIP), Carlos Eduardo shity Tomita, representing the State Treasury Secretariat of S&atilde;o Paulo, Carlos Eduardo Baptista de Sa, president of ABIT (Brazilian Association of Metal Tubes and accessories), Jose Adolfo Smith, executive director of Abit, Fernando Lummertz, president of the Brazilian Trade Targiani business and Luciano, executive director of Tarcom Specials.</p>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		&nbsp;</p>\n");
		content.append("	<p style=\"font-size: 13px; font-family: Arial, Helvetica, sans-serif; padding-bottom: 0px; text-align: justify; padding-top: 0px; padding-left: 0px; margin: 12px 0px; line-height: 19px; padding-right: 0px\">\n");
		content.append("		&nbsp;</p>\n");
		...
		String result=replaceAll(replaceAll(content.toString(), "$", "\\$"),"\n","");
