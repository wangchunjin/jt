	...
	<head>
		...
		<script>
			...
			$(document).ready(function() {
				...
				$(".sub_03 .rolldown").click(function(){
					var top_offset = $(this).parent().prev().offset().top;
					var top_offset2 =$(this).parent().prev().find(".sub_04:last").offset().top;
					var top_offset3 = $(this).parent().offset().top;
					if(top_offset2+45>top_offset3)
					$(this).parent().prev().offset({top:top_offset-45});
				});
				$(".sub_03 .rollup").click(function(){
					var top_offset = $(this).parent().prev().offset().top;
					if(top_offset<64)
					$(this).parent().prev().offset({top:top_offset+45});
				});				
			...
			function load_default(){
				var url = "web/SYS/FIRST/index.jsp";
...
// 	function openHelp(){
// 			var width = window.screen.width-100; //窗口宽度
// 			var height = window.screen.height-100; //窗口高度
// 			var wtop=20;
// 			var wleft=50;
// 			var urlTo = "http://www.gpmis.com:12345/upk";
// 	 		window.open(urlTo,"","height=" + height + ",width=" + width + ", resizable=no,status=no,center=yes,top=" + wtop + ",left=" + wleft);		        	 

// 	}
	
	function openHelp(){
		createSimpleWindow("CountWindow","注册人数统计","${ctx}/user/tuser/findCount.action", 500,200);		        	 

}
	
 	</script>
	</head>
	<body onLoad="InitWin();startTime()">
		<!--收缩按钮-->
				...
				<div class="header_center">
					<div class="header_center_area">
						...
						<div class="header_content">
							...
							<a
								href="javaScript:addTab('password','资料修改','ChangeUserInfo.action?type=UserInfo')"><img
...
<!-- 													</div>																																			 -->
		...
		<div class="page_right" id="page_right">
			<div class="top">
				...
				<div class="user_info">
<!-- 					<div style="border-right:1px dotted #c2e4f4;padding:0 12px;text-shadow:1px 1px 0 #1d8fc7;line-height:20px;height:42px;float:left;color:#fff;text-align:center"> -->
<!-- 						<a style="margin:4px 0 0 0;display:block;background:url(${ctx}/webResources/style/images/default/help.png) no-repeat;width:36px;height:36px" href="#" onClick="openHelp()" title="注册人数"></a> -->
<!-- 					</div> -->
<!-- 					<div class="drawer"> -->
...
<!-- 					</div> -->
			...
			<div class="bottom">
				...
				<div style="float: right;margin-right: 30px;margin-top: 3px;"><input type="hidden" id="CurrProjId" value ="${UserInfo.getProjId()}" >
<!-- 				<span>当前项目：</span><span id="CurrProj">${UserInfo.getProjShortName()}--${UserInfo.getProjName()}</span> -->
				</div>
				</div>
			</div>
		</div>
