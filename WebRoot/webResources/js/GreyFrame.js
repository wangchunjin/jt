...
//    bgIframe.style.backgroundColor = "gray";
    ...
    titleDiv.style.cssText = 'color: #ffffff; background-color: #000000; text-align: center; ';
    ...
    closeSpan.style.cssText = 'color: #fff; text-align: center; ';
    closeSpan.style.cssFloat = "right";
    closeSpan.style.styleFloat = "right";
	closeSpan.style.background='url(close.png)';
