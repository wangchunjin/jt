...
function easyTabs(menunr, active) {
	...
	for (i = 1; i <= tabcount[menunr]; i++) {
		...
		//alert("pppp: "+document.getElementById("serviceItem.id").value);
...
window.onload = function () {
	...
	if(!(document.getElementById(tabcontent_idname[0]+1) 
			&& document.getElementById(tablink_idname[0]+1))) return false;
	var a = 0;
	var b = 1;
	do {
