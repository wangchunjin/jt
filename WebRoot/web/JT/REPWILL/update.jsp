 ...
 <script type="text/javascript">
	     function UpdateRecord(){
	        ...
	        if(comment==null || trim(comment)==""){
	        	$.messager.alert("错误","还款意愿名称不能为空！");
	        	return;
	        }
	        
	        var res = $('#addForm').SubmitForm("${ctx}/repwill/trepwill/update.action");
...
#imghead {
  ...
  <body class="NewWinClass">
   ...
   <div style="height:300px;overflow: auto;" >
		...
		<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>还款意愿名称：</th>
				<td colspan="3" width="30%">
				<input  type="hidden" class="form_text"  name="repwill.id" id="id"  value="${repwill[0].id }" >
				<input  type="" class="form_text"  name="repwill.name" id="name"  value="${repwill[0].name }" >
				</td>
		</tr>
