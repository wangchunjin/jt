  ...
  <head>
  	<script type="text/javascript">
	  	function add(){	  		
	        ...
	        createSimpleWindow("addWindow","新增","${ctx}/web/JT/HELP/addPic.jsp?currFrameId="+currFrameId, 800,600);
	    }
	    ...
	    function update(){
			...
			createSimpleWindow("eidtWindow","修改配置","${ctx}/help/thelp/findById.action?id="+rows[0].id+"&currFrameId="+currFrameId,800,600);
  ...
  <table width="100%">
       <tr>
          <td width="*" align="right">
          	 <epmis:button id="NewRecord" imageCss="icon-add" value="增加" action="add()" datactrCode="help_add.edit" ></epmis:button>
