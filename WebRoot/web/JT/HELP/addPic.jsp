...
<script type="text/javascript" src="js/imagePreview.js"></script>
 <script type="text/javascript">
	     function AddRecord(){	    	 
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/help/thelp/save.action");
   ...
   <div style="height:500px;overflow: auto;" >
   	<table style="margin-top: 10px;width: 96%;" >
			<tr>
				...
				<td  >
				<input  type="" class="form_text"  name="help.title" id="title">
				</td>
			</tr>
			<tr>
				<th width="10%;" align="right"><span style="color: red;">*</span>排序数字：</th>
				<td>
				<input  type="" class="form_text"  name="help.orderflag" id="orderflag"   >
				</td>
			</tr>
			<tr>
				<th width="10%;" align="right"><span style="color: red;">*</span>帮助内容：</th>
				<td>
					<textarea rows="20" cols="" name="help.content" id="content"></textarea>
				</td>
			</tr>
