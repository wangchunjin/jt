...
<script>
         ...
         $(function(){       	
        	 ...
        	 var fp_jg = '${param.fp_jg}';
        	var jg_name='${sessionScope.UserInfo.userId}';
        	...
        	var mobile='${param.mobile}';
         	...
         	remoteSort:false,
				...
				url: "${ctx}/orderinfo/torderinfo/findAllOrderinfo.action?isdel="+isdel+"&approve_status="+approve_status+"&transfer_status=3"+"&fp_jg="+fp_jg+"&jg_name="+jg_name+"&zgtime="+zgtime+"&jgtime="+jgtime+"&mobile="+mobile,        
				frozenColumns:[[
				]],
...
// 					},
					...
					{field:'fp_jg',title:'分配状态',width:0.1,align:'center' ,sortable:true,
						formatter:function(value,row,index){
		                   	if(value==0)
