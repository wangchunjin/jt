...
<script type="text/javascript">
	...
	function UpdateRecord() {
		...
		var res = $('#addForm').SubmitForm("${ctx}/crecord/tcrecord/update.action");
		if (res[0].result == "success") {
			
			parent.GetIndexFrame("CuishouWindow_frm").LeftFrame.TwoFrame.location.reload();
   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >
			...
			<tr style="display: none;">
				...
				<td width="20%" align="left">			
					<s:radio id="emergency_contact" name="crecord.emergency_contact"  list="#{'0':'是','1':'否'}"   value="#request.crecord[0].emergency_contact" theme="simple" onchange="gai();"  ></s:radio>
				</td>
			</tr>
			<tr style="display: none;">
				<th width="20%" align="right"><span style="color: red;">*</span>是否联系其它联系人：</th>
				<td width="20%" align="left">			
					<s:radio id="contact_other_contacts" name="crecord.contact_other_contacts"  list="#{'0':'是','1':'否'}"   value="#request.crecord[0].contact_other_contacts" theme="simple" onchange="gai();"  ></s:radio>
				</td>
			</tr>
			<tr style="display: none;">
				<th width="20%" align="right"><span style="color: red;">*</span>通讯录联系情况：</th>
				<td width="20%">
					<textarea name="crecord.cus_beh" id="cus_beh" rows="5" cols="">${crecord[0].cus_beh}</textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="20%">
					<textarea name="crecord.content" id="content" rows="5" cols="">${crecord[0].content}</textarea>
				</td>
			</tr>
