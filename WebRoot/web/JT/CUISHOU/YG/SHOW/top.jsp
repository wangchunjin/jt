...
<html>
  <head>
  	...
  	function jb(){
  		alert(123);
  		LeftFrame.location.href= "${ctx}/web/JT/CUISHOU/YG/content.jsp?approve_status=1"+"&transfer_status=3&fp_jg=1"+"&collection="+collection;
  	}
  	...
  	**/
  	function cscs11(){
    	...
    	createSimpleWindow("CuishouWindows","hhh","${ctx}/web/JT/CUISHOU/YG/show.jsp?currFrameId="+currFrameId+"&id="+rows[0].order_id, 800,600);
...
// 					alert(res[0].result);
  ...
  <table width="100%">
       <tr>
          ...
          <epmis:button id="NewRecord" imageCss="icon-edit" value="基本信息" action="jb()" datactrCode="" ></epmis:button>
