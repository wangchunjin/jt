...
<frame name="LeftFrame" id="LeftFrame" noresize="noresize" src="${ctx}/orderinfo/torderinfo/findById_lookt.action?id=${param.cid}&rid=${param.id}" frameborder="0" scrolling="no">
