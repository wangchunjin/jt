...
// 		 var approve_status = $("#approve_status").val();	 	
	  ...
	  TwoFrame.location.href= "${ctx}/web/JT/CUISHOU/YG/content.jsp?approve_status=1"+"&transfer_status=3&fp_jg=1"+"&collection="+collection+"&zgtime="+zgtime+"&jgtime="+jgtime+"&mobile="+mobile;
  }
</script>
</head>
...
<table width="100%" border="0">
   <tr height="25" >
      ...
      <td width="75" height="25" align="right">&nbsp;催收状态：&nbsp;</td>
      <td width="100">
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/JT/CUISHOU/YG/content.jsp?fp_jg=1&collection=0" frameborder="0" scrolling="no"></iframe>
</div>
