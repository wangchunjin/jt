...
//   		 var rid = '${param.rid}';
	  ...
	  TwoFrame.location.href= "${ctx}/web/JT/ORDER/INFO/content.jsp?approve_status="+approve_status+"&transfer_status="+transfer_status+"&mobile="+mobile;
  }
</script>
</head>
...
<table width="100%" border="0">
   <tr height="25" >
      ...
      <td width="75" height="25" align="right">&nbsp;审核状态：&nbsp;</td>
      <td width="100">
      ...
      <td width="100">
       	<select id="transfer_status" class="form_text">
       		...
       		<option value="6">未确认</option>
       		<option value="7">打款异常</option>
			<option value="8">待财务确认</option>
       	</select>
      </td>
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/JT/ORDER/INFO/content.jsp?transfer_status=0" frameborder="0" scrolling="no"></iframe>
</div>
