...
// 					双击某行触发查看事件
				...
				columns:[[
					...
					{field:'orderid',title:'订单id',width:0.1,align:'center' ,sortable:true,
						
					},
                    {field:'ordernum',title:'订单编号',width:0.1,align:'center' ,sortable:true,
						...
						formatter:function(value,row,index){
							if(row.approve_status==1){
								if(value==0)
			                   	...
			                   	if(value==7)
			                   		return "<span style='color:#8B6969;'>打款异常</span>";
                                if(value==8)
                                    return "<span style='color:#8B6969;'>待财务确认</span>";
							}else{
								return "--";
							}
