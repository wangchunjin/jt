...
<script type="text/javascript">
  function searchByKey(){
	 	 ...
	 	 var id='${param.id}';
		 var isdel = $("#isdel").val();  
	  TwoFrame.location.href= "${ctx}/web/JT/CONNECT/RECORD/content.jsp?isdel="+isdel+"&oid="+id;
...
<div style="position: absolute;top: 0px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/JT/CONNECT/RECORD/content.jsp?oid=${param.id}" frameborder="0" scrolling="no"></iframe>
</div>
</body>
</html>