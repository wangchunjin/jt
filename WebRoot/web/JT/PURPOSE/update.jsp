 ...
 <script type="text/javascript">
	     function UpdateRecord(){
	        ...
	        if(comment==null || trim(comment)==""){
	        	$.messager.alert("错误","借款用途名称不能为空！");
	        	return;
	        }
	        
	        var res = $('#addForm').SubmitForm("${ctx}/purpose/tpurpose/update.action");
...
#imghead {
  ...
  <body class="NewWinClass">
   ...
   <div style="height:300px;overflow: auto;" >
		...
		<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>借款用途名称：</th>
				<td colspan="3" width="30%">
				<input  type="hidden" class="form_text"  name="purpose.id" id="id"  value="${purpose[0].id }" >
				<input  type="" class="form_text"  name="purpose.name" id="name"  value="${purpose[0].name }" >
				</td>
		</tr>
