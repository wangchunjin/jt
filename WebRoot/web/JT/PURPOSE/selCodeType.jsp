...
// 		 var isdel = $("#isdel").val();	 	 
	  ...
	  TwoFrame.location.href= "${ctx}/web/JT/PURPOSE/content.jsp";
  }
</script>
</head>
...
<div style="position: absolute;top: 0px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/JT/PURPOSE/content.jsp" frameborder="0" scrolling="no"></iframe>
</div>
