...
<script>
         ...
         $(function(){
         	...
         	remoteSort:false,
				...
				url: "${ctx}/bankname/tbankname/findAllBankname.action?isdel="+isdel,        
				frozenColumns:[[
				]],
				...
				columns:[[
					...
					{field:'code',title:'code',width:0.1,align:'center' ,sortable:true,
						
					},
					{field:'name',title:'name',width:0.1,align:'center' ,sortable:true,
						
					},
					{field:'code_zfb',title:'支付宝code',width:0.1,align:'center' ,sortable:true,
