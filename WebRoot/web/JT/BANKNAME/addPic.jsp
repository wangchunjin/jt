...
<script type="text/javascript" src="js/imagePreview.js"></script>
 <script type="text/javascript">
	     function AddRecord(){
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/bankname/tbankname/save.action");
   ...
   <div style="height:300px;overflow: auto;" >
   	<table style="margin-top: 30px;width: 84%;" >
			<tr>
				...
				<input  type="" class="form_text"  name="bankname.name" id="name"   >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>code：</th>
				<td colspan="3" width="30%">
					<input  type="" class="form_text"  name="bankname.code" id="code"   >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>支付宝code：</th>
				<td colspan="3" width="30%">
					<input  type="" class="form_text"  name="bankname.code_zfb" id="code_zfb"   >
				</td>
			</tr>
