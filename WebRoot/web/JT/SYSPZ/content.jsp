...
<script>
         ...
         $(function(){
         	...
         	remoteSort:false,
				...
				url: "${ctx}/sysconf/tsysconf/findAllSysconf.action?isdel="+isdel,        
				frozenColumns:[[
				]],
				...
				columns:[[
					...
					{field:'param',title:'param',width:0.1,align:'center' ,sortable:true,
						
					},
					{field:'value',title:'value',width:0.1,align:'center' ,sortable:true,
						
					},
					{field:'comment',title:'comment',width:0.1,align:'center' ,sortable:true,
