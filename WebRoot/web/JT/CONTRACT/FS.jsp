...
<!-- 	<frame name="OneFrame" id="OneFrame"   noresize="noresize" src="${ctx}/web/JT/CONTRACT/top.jsp"         frameborder="0" scrolling="no"> -->
	<frame name="LeftFrame" id="LeftFrame" noresize="noresize" src="${ctx}/web/JT/CONTRACT/selCodeType.jsp" frameborder="0" scrolling="no">
