...
<script type="text/javascript" src="js/imagePreview.js"></script>
 <script type="text/javascript">
	     function AddRecord(){
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/lender/tlender/save.action");
...
<style type="text/css">
  ...
  <body class="NewWinClass">
   ...
   <div style="height:300px;overflow: auto;" >
   	<table style="margin-top: 30px;width: 84%;" >
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>姓名：</th>
				<td colspan="3" width="30%">
				<input  type="" class="form_text"  name="lender.name" id="name"   >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>身份证号：</th>
				<td colspan="3" width="30%">
					<input  type="" class="form_text"  name="lender.idcard" id="idcard"   >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>手机号：</th>
				<td colspan="3" width="30%">
					<input  type="" class="form_text"  name="lender.mobile" id="mobile"   >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>额度：</th>
				<td colspan="3" width="30%">
					<input  type="" class="form_text"  name="lender.money" id="money"   >
				</td>
			</tr>
