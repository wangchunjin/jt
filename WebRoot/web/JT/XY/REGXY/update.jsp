...
//         	}
		...
		var res = $('#addForm').SubmitForm("${ctx}/agree/tagree/updateReg.action");
...
<!-- 				</tr> -->
			...
			<tr id="hhh">
			<th width="10%" align="right"><span style="color: red;">*</span>注册协议：</th>
			
				<td>
					<textarea id="CONTENTT" name="CONTENTT" class="label_textarea"  style="height: 400px;width: 880px;" >${agree[0].register_content }</textarea> 					   	  
				</td>
			</tr>
       </table>
       <input class="form_text" type="hidden"  name="agree.register_content" id="content"  value="${agree[0].register_content }">	
</form>
</div>
	<div class="BottomDiv">
		<epmis:button id="NewRecord" imageCss="icon-edit" value="确定" action="UpdateRecord()" datactrCode="xy_reg.edit" ></epmis:button> 
<!-- 		<a -->
