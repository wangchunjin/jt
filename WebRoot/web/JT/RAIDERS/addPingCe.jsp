...
// 			 var r3=/^([hH][tT]{2}[pP]:\/\/|[hH][tT]{2}[pP][sS]:\/\/)(([A-Za-z0-9-~]+)\.)+([A-Za-z0-9-~\/])+$/;
 	     ...
 	     var r3=/^(http:\/\/|https:\/\/).*$/;
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/raiders/traiders/save.action");
  ...
  <body class="NewWinClass">
   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >
			<tr id="aaa" >
				<th width="20%" align="right"><span style="color: red;"></span>攻略图片：</th>
				<td width="30%">
...
<!-- 			<tr   > -->
<!-- 				<th width="20%" align="right"><span style="color: red;">*</span>攻略标题：</th> -->
<!-- 				<td width="20%"><input class="form_text"  name="adv.title" id="title"  value=""></td> -->
<!-- 			</tr>		 -->
			<tr>
				<th width="20%" align="right"><span style="color: red;">*</span>攻略内容状态：</th>
				<td width="20%">
			
					<select class="form_text" name="raiders.type" id="type" onchange="check()" style="width: 100%;">
						<option value="2">攻略链接</option>
						<option value="1">攻略文本</option>
			...
			<tr id="ttt"  >
				<th width="20%" align="right"><span style="color: red;">*</span>攻略内容(链接)：</th>
				<td width="20%"><input class="form_text"  name="raiders.url" id="url"  value=""></td>
			</tr>
			
			
			<tr id="hhh" style="display:none;">
			<th width="20%" align="right"><span style="color: red;">*</span>攻略内容(文本)：</th>
...
<!--        </tr> -->
       ...
       <input class="form_text" type="hidden"  name="raiders.content" id="content"  value="">	
</form>
</div>
		<div class="BottomDiv">
