...
<script type="text/javascript">
  function searchByKey(){
	  ...
	  TwoFrame.location.href= "${ctx}/web/JIGUAN/JIGUANCAR/content.jsp?title="+encodeURI(title)+"&isdel="+isdel;
  }
</script>
</head>
...
<table width="100%" border="0">
   <tr height="25" >
      ...
      <td width="75" height="25" align="right">&nbsp;是否读取：&nbsp;</td>
      <td width="100">
...
<div style="position: absolute;top: 0px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/JIGUAN/JIGUANCAR/content.jsp" frameborder="0" scrolling="no"></iframe>
</div>
</body>
</html>