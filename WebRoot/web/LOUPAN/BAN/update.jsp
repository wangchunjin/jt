...
<script type="text/javascript">
	...
	function UpdateRecord() {
		...
		var res = $('#addForm').SubmitForm("${ctx}/ban/tban/update.action");
	...
	$(function(){
		var result = GetXmlBySql("select ban_pic from t_prosale where id='"+${ban[0].l_id }+"'");	
...
<body class="NewWinClass">
   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >
			...
			<tr align="right">	
			<input class="form_text" type="hidden"  name="ban.id" id="id"  value="${ban[0].id }" >		
			<input class="form_text" type="hidden"  name="ban.l_id" id="lid"  value="${ban[0].l_id }" >		
				<th width="10%"><span style="color: red;">*</span>名称：</th>
				<td width="20%">				
				<input class="form_text"  name="ban.name" id="name"  value="${ban[0].name }" ></td>
				<th width="10%"><span style="color: red;">*</span>单元数：</th>
				<td width="20%"><input class="form_text"  name="ban.unit_number" id="unit_number"  value="${ban[0].unit_number }"></td>						
			...
			<tr align="right">			
				...
				<td width="20%">				
					<select class="form_text" name="ban.status" id="status">
						<option value="1" <c:if test="${ban[0].status==1 }">selected="selected"</c:if>>待售</option>
						<option value="2" <c:if test="${ban[0].status==2 }">selected="selected"</c:if>>在售</option>
						<option value="3" <c:if test="${ban[0].status==3 }">selected="selected"</c:if>>售罄</option>						
					</select>
				
				</td>
				<th width="10%"><span style="color: red;">*</span>梯户比：</th>
				<td width="20%"><input class="form_text"  name="ban.ladder" id="ladder"  value="${ban[0].ladder }"></td>						
			...
			<tr align="right">
				...
				<td>
						...
						<input type="text" style="width: 100%;" value="${ban[0].households }" class="form_text" name="ban.households" id="households"  >
				...
				<input type="text" style="width: 100%;" value="${ban[0].floor }" class="form_text" name="ban.floor" id="floor" >
			...
			<tr align="right">
				...
				<td>
						...
						<input type="text" style="width: 100%;" value="${ban[0].opentime }" onchange="findbycoi()" readonly="readonly" class="form_text" name="ban.opentime" id="opentime" onclick="WdatePicker({el:'opentime'})" >					
					
				</td>
				<th><span style="color: red;">*</span>交房时间：</th>
				<td>
					
				<input type="text" style="width: 100%;" readonly="readonly" value="${ban[0].otherhousetime }" onchange="findbycoi()" class="form_text" name="ban.otherhousetime" id="otherhousetime" onclick="WdatePicker({el:'otherhousetime'})">
			...
			<tr align="right">
				...
				<td>
						...
						<input type="text" style="width: 100%;" readonly="readonly" value="${ban[0].x }" class="form_text" name="ban.x" id="x"  >
				...
				<input type="text" style="width: 100%;" readonly="readonly" value="${ban[0].y }" class="form_text" name="ban.y" id="y" >
