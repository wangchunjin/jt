...
// }
         ...
         $(function(){
         	...
         	remoteSort:false,
				...
				url: "${ctx}/ban/tban/findAllBan.action?isdel="+isdel+"&lid="+lid,        
				frozenColumns:[[
				]],
				...
				columns:[[		
					...
					{field:'unit_number',title:'单元数',width:0.2,align:'center' ,sortable:true,
						
					},
					{field:'ladder',title:'梯户比',width:0.2,align:'center' ,sortable:true,
						
					},
					{field:'households',title:'总户数',width:0.2,align:'center' ,sortable:true,
						
					},
					{field:'floor',title:'楼层',width:0.2,align:'center' ,sortable:true,
						
					},
					{field:'opentime',title:'开盘时间',width:0.2,align:'center' ,sortable:true,
						
					},
					{field:'otherhousetime',title:'交房时间',width:0.2,align:'center' ,sortable:true,
