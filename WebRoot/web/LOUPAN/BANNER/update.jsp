...
// 			 var r3=/^([hH][tT]{2}[pP]:\/\/|[hH][tT]{2}[pP][sS]:\/\/)(([A-Za-z0-9-~]+)\.)+([A-Za-z0-9-~\/])+$/;
		...
		var res = $('#addForm').SubmitForm("${ctx}/banner/tbanner/update.action");
...
<body class="NewWinClass">
   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >
			<tr>
<!-- 			<input class="form_text" type="hidden"  name="banner.oid" id="oid"  value="${banner[0].oid }"/> -->
				<th width="20%"><span style="color: red;">*</span>首页轮播图片：</th>
				<td width="30%">
				<input type="hidden" class="form_text"  name="banner.id" id="id"  value="${banner[0].id }">
				<div class="lf salebd"><a href="#"  id="preview"><img id="imghead"  src="${ctx}${banner[0].pic}" width="NAN" height="100" /></a></div><br>
...
<!-- 						<option value="4" <c:if test="${banner[0].type==4 }">selected="selected"</c:if>>户型</option> -->
			...
			<tr id="ttt">
				<th width="20%"><span style="color: red;">*</span>首页轮播内容(链接)：</th>
				<td width="20%"><input class="form_text"  name="banner.url" id="url"  value="${banner[0].url }"></td>
				</tr>
			
			<tr id="hhh">
			<th width="20%"><span style="color: red;">*</span>首页轮播内容(文本)：</th>
...
<!--        </tr> -->
       ...
       <input class="form_text" type="hidden"  name="banner.content" id="content"  value="${banner[0].content }">	
</form>
</div>
	<div class="BottomDiv">
