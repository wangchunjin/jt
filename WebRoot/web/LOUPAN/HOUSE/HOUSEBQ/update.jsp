...
<html>
 ...
 <script type="text/javascript">
	     function UpdateRecord(){
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/houselabel/thouselabel/update.action");
  ...
  <body class="NewWinClass">
   ...
   <div style="height:300px;overflow: auto;" >
		...
		<tr>
				...
				<input  type="hidden" class="form_text"   name="houselabel.id" id="id"  value="${houselabel[0].id }" >
				<input  type="" class="form_text"  name="houselabel.name"  id="name"  value="${houselabel[0].name }" >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>标签颜色名称：</th>
				<td colspan="3" width="30%">
				<input  type="" class="form_text"  name="houselabel.cname" id="cname"  value="${houselabel[0].cname }"  >
				</td>
			</tr>
			<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>标签色值：</th>
				<td colspan="3" width="30%">
				<input  type="" class="form_text"  name="houselabel.color" id="color" placeholder="色值如：#FF0000"  value="${houselabel[0].color }"  >
				</td>
			</tr>
