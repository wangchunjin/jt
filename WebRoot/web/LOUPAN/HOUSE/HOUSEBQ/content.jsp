...
<script>
         ...
         $(function(){
         	...
         	remoteSort:false,
				...
				url: "${ctx}/houselabel/thouselabel/findAllHouselabel.action?isdel="+isdel,        
				frozenColumns:[[
				]],
				...
				columns:[[
					...
					{field:'name',title:'楼盘户型标签名称',width:0.1,align:'center' ,sortable:true,
						
					},
					{field:'cname',title:'标签颜色',width:0.1,align:'center' ,sortable:true,
