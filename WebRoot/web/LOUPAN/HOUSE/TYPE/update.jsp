 ...
 <script type="text/javascript">
	     function UpdateRecord(){
	        ...
	        if(name==null || trim(name)==""){
	        	$.messager.alert("错误","户型类别标签名称不能为空！");
	        	return;
	        }
	        
	        var res = $('#addForm').SubmitForm("${ctx}/housetype/thousetype/update.action");
...
#imghead {
  ...
  <body class="NewWinClass">
   ...
   <div style="height:300px;overflow: auto;" >
		...
		<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>户型类别标签名称：</th>
				<td colspan="3" width="30%">
				<input  type="hidden" class="form_text"   name="housetype.id" id="id"  value="${housetype[0].id }" >
				<input  type="" class="form_text"  name="housetype.name"  id="name"  value="${housetype[0].name }" >
				</td>
			</tr>
