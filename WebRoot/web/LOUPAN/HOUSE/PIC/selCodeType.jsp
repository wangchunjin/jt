...
<script type="text/javascript">
  function searchByKey(){
	  ...
	  TwoFrame.location.href= "${ctx}/web/LOUPAN/HOUSE/PIC/content.jsp?isdel="+isdel+"&lid="+lid;
  }
</script>
</head>
...
<!--       <td width="100" height="25" align="right">楼盘图片类别：&nbsp;</td> -->
<!--        <td width="100"> -->
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/LOUPAN/HOUSE/PIC/content.jsp?lid=${param.lid}" frameborder="0" scrolling="no"></iframe>
</div>
</body>
</html>