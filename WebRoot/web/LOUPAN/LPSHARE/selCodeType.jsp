...
<script type="text/javascript">
  function searchByKey(){
	  ...
	  TwoFrame.location.href= "${ctx}/web/LOUPAN/LPSHARE/content.jsp?isdel="+isdel+"&uid="+uid+"&realname="+realname+"&telephone="+telephone;
  }
</script>
</head>
...
<!--        	</select> -->
<!--       </td> -->
		<td width="75" height="25" align="right">&nbsp;姓名：&nbsp;</td>
		      <td width="100">
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/LOUPAN/LPSHARE/content.jsp?uid=${param.uid}" frameborder="0" scrolling="no"></iframe>
</div>
