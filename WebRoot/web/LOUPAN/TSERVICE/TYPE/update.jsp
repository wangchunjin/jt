 ...
 <script type="text/javascript">
	     function UpdateRecord(){
	        ...
	        if(name==null || trim(name)==""){
	        	$.messager.alert("错误","服务类别名称不能为空！");
	        	return;
	        }
	        
	        var res = $('#addForm').SubmitForm("${ctx}/servicetype/tservicetype/update.action");
...
#imghead {
  ...
  <body class="NewWinClass">
   ...
   <div style="height:300px;overflow: auto;" >
		...
		<tr>
				<th width="20%;" align="right"><span style="color: red;">*</span>服务类别名称：</th>
				<td colspan="3" width="30%">
				<input  type="hidden" class="form_text"   name="servicetype.id" id="id"  value="${servicetype[0].id }" >
				<input  type="" class="form_text"  name="servicetype.name"  id="name"  value="${servicetype[0].name }" >
				</td>
			</tr>
