...
<html>
 ...
 function AddRecord(){
 	     ...
 	     //判断网址http://https://开头，或者不是网址！
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/cons/tcons/save.action");
...
<!-- 				<th align="left"><div class="lf salebd"><a href="#"  id="preview"><img id="imghead3"  src="../../../images/ic_pic_loading.png" width="100" height="80" /></a></div><br></th> -->
			...
			<tr id=""  align="right">
				...
				<td width="20%"><input class="form_text"  name="cons.title" id="title"  value=""></td>
			</tr>
			<tr id=""  align="right">
				<th width="10%"><span style="color: red;">*</span>资讯类别：</th>
				<td width="20%">
				
				<epmis:select  id="cons.typeid" define="select id,name from t_cons_type where isdel='0'  " attr="style='width: 100%;'" onChange="check()" ></epmis:select>
				</td>
			</tr>
			<tr align="right">
			...
			<tr id="ttt"  align="right">
				...
				<td width="20%"><input class="form_text"  name="cons.url" id="url"  value=""></td>
			</tr>
       ...
       <input class="form_text" type="hidden"  name="cons.content" id="content"  value="">	
</form>
</div>
		<div class="BottomDiv">
