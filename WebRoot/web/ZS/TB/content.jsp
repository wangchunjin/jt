    ...
    createSimpleWindow("lookWindow","资讯文本查看","${ctx}/cons/tcons/findById.action?cid="+obj, 1000,600);
         ...
         $(function(){         
         	...
         	remoteSort:false,
				...
				url: "${ctx}/zs/tzs/findAllZstb.action?month="+month+"&pinyin="+pinyin+"&quyu="+quyu,        
				frozenColumns:[[
				]],				
				columns:[[		
					...
					{field:'yuefen',title:'月份',width:0.2,align:'center' ,sortable:true,
						
					},
					{field:'price',title:'金额',width:0.2,align:'center' ,sortable:true,
