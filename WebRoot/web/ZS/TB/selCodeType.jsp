...
<script type="text/javascript">
  function searchByKey(){  		 
	...
	var quyu=$("#quyu").find("option:selected").text();
	  ...
	  TwoFrame.location.href= "${ctx}/web/ZS/TB/content.jsp?month="+month+"&pinyin="+pinyin+"&quyu="+quyu;
  }
...
<table width="100%" border="0">
   ...
   <td width="75" height="25" align="right">&nbsp;月份：&nbsp;</td>
       <td width="100">      	 
      	  <input class="form_text"  name="month" id="month" readonly="readonly"  value="" onfocus="DataEdit('yyyy年-MM月','','')">		
       </td>
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/ZS/TB/content.jsp" frameborder="0" scrolling="no"></iframe>
</div>
</body>
</html>