...
<html>
	<head>
       ...
       function openDoc(url,id){
         ...
         $(function(){ 
        	 var id = '${param.ID}';
        	 var officetpl_flag = '${param.OFFICETPL_FLAG}';
       	$('#StructVersionTable').datagrid({
                remoteSort:false,
                fitColumns:true,
                striped:true,               
				url: '${ctx}/sys/struct/StructVersionTable.action?ID='+id+'&OFFICETPL_FLAG='+officetpl_flag,
				frozenColumns:[[
	...
	<body>
		...
		<table id="StructVersionTable" class="TreeClass" ></table>
		</div>
   </body>
