...
<frameset name="MainFrame" id="MainFrame" noresize="noresize" scrollTopHeight="0" stTrId="" rows="28,*" cols="*" frameborder="0" border="0" bordercolor="lightgreen">
	<frame name="OneFrame" id="OneFrame" noresize="noresize" src="${ctx}/web/SYS/USER/PROJFILE/top.jsp?USER_ID=${param.USER_ID}&PROFILE_ID=${param.PROFILE_ID}" frameborder="0" scrolling="no">
