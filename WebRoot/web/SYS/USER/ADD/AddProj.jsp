	...
	<head>
        ...
        $(function(){ 
           ...
           function AddRecord(){
			    ...
			    var flag="";
			    var res=  IntoActionByUrl("${ctx}/sys/user/DeleteProjUser.action?USER_ID="+userId);
			    flag = res[0].result;
			    var datas="";
			    var i=0;
                ...
                $("input[name='selectbox']:checked").not(':disabled').each(function(){
                	 ...
                	 if(i==length){
                		  res =   IntoActionByUrl("${ctx}/sys/user/InsertProjUser.action?USER_ID="+userId+"&PROJ_IDS="+datas);
                	 }else if(i%50==0){
                		 res =   IntoActionByUrl("${ctx}/sys/user/InsertProjUser.action?USER_ID="+userId+"&PROJ_IDS="+datas);
                		 datas="";
                	 }
                ...
                flag = res[0].result;
        	     ...
        	     flag = res[0].result;
			     if(flag=="success"){
			         parent.OneFrame.nextstep('5',userId);
			     }else{
