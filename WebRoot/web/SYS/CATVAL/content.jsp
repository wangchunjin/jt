...
<html>
        	...
        	$('#CatvalTree').treegrid({
				...
				columns:[[
	 			...
	 			onBeforeExpand:function(node){
					$('#CatvalTree').treegrid('options').url = "${ctx}/sys/catval/AddCatvalTree.action?&parentId=" + node.CATG_ID+"&catg_type_id="+catg_type_id;
				} ,
				onClickRow:function(node){
				var where = node.CATG_ID;
	...
	<body>
		...
		<table id="CatvalTree" class="TreeClass"></table>
		</div>
	</body>
