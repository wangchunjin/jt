        ...
        $(function(){ 
       	var catg_type_id = '${param.catg_type_id}';
        	$('#ProjTree').treegrid({
				...
				url: '${ctx}/sys/proj/ProjTreeCattye.action?parentId=0&catg_type_id='+catg_type_id,
				idField:'PROJ_ID',
				...
				columns:[[
	 			...
	 			onBeforeExpand:function(node){
					$('#ProjTree').treegrid('options').url = "${ctx}/sys/proj/ProjTreeCattye.action?&parentId=" + node.PROJ_ID+"&catg_type_id="+catg_type_id;
				},
