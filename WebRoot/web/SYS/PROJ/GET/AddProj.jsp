...
<html>
 ...
 <script type="text/javascript">
            $(function(){
            	 var ParentProjId = parent.OneFrame.$("#ParentProjId").val(); 
                 $("#cmProj\\.parentProjId").val(ParentProjId)
            })
         function  AddRecord(){
						...
						success:function(data){
						 ...
						 if(isNull(node)){                  
					          ...
					          if(isNull(newRow)){
					        	  ...
					        	  IntoActionByUrl("${ctx}/jygl/jygl_tbjg/AddProj.action?tbjgId=${param.TBJG_ID}&projId="+data[0].projId)
				 				 parent.OneFrame.nextstep('2',data[0].projId);
  ...
  <body class="NewWinClass" >
   <form method="post" action="" id="addForm" name="addForm">
		<table style="width: 96%;">
			...
			<tr>
				<th width="12%">项目名称</th>
				<td width="88%" colspan="3" ><input class="form_text"   name="cmProj.projName" id="cmProj.projName" value="${param.PROJ_NAME } "></td>
			</tr>
			<tr>
				<th width="12%">开工日期</th>
				<td width="38%">
	       ...
	       <input type="hidden" id="cmProj.parentProjId" name="cmProj.parentProjId"  >							
</form>
			<div class="BottomDiv">
