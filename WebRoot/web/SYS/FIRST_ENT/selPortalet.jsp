		...
		<script>
         ...
         $(function(){ 
        	$('#SysPortalTable').datagrid({
                ...
                fitColumns:true,
                striped:true,
                queryParams:{USER_ID:userId,p_type:'ENT'},
                selectOnCheck:false,
                checkOnSelect:true,
                singleSelect:true,
                idField:'P_ID',  
				url: '${ctx}/cc/portal/userPortaletEnt.action',
				columns:[[
         	...
         	function userSelPortalet(obj){
         		...
         		var res=  IntoActionByUrl("${ctx}/cc/portal/userSelPortalet.action?USER_ID="+userId+"&pIds="+pIds+"&p_type=ENT");
