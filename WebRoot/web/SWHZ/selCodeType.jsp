...
//   		 var rid = '${param.rid}';
	  ...
	  TwoFrame.location.href= "${ctx}/web/SWHZ/content.jsp?isdel="+isdel+"&type="+type+"&status="+status;
  }
</script>
</head>
...
<table width="100%" border="0">
   <tr height="25" >
      ...
      <td width="100">
       ...
       <td width="75" height="25" align="right">&nbsp;是否处理：&nbsp;</td>
      <td width="100">
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/SWHZ/content.jsp" frameborder="0" scrolling="no"></iframe>
</div>
