  ...
  <head>
  	<script type="text/javascript">
	  	function add(){
	        ...
	        createSimpleWindow("addWindow","增加版本","${ctx}/web/EDITION/addCar.jsp?currFrameId="+currFrameId, 700,600);
	    }
	    function update(){
	    ...
	    var currFrameId =  parent.frameElement.id;
			...
			createSimpleWindow("eidtWindow","修改配置","${ctx}/edition/tedition/findById.action?id="+rows[0].id+"&currFrameId="+currFrameId,800,600);
	  	...
	  	function del(){
			...
			parent.LeftFrame.TwoFrame.$.messager.confirm("提醒","确定要删除?",function(res){
	        	...
	        	if(res){
					var res = IntoActionByUrl("${ctx}/edition/tedition/delete.action?id="+ids);
  ...
  <table width="100%">
       <tr>
          <td width="*" align="right">
          	 ...
          	 <epmis:button id="NewRecord" imageCss="icon-add" value="增加" action="add()" datactrCode="edition_add.edit" ></epmis:button>
<!--           	 <epmis:button  id="DeleteRecord" imageCss="icon-remove" value="删除" action="del()" datactrCode=""  ></epmis:button> -->
          	
          	 <epmis:button id="NewRecord" imageCss="icon-edit" value="修改" action="update()" datactrCode="edition_update.edit" ></epmis:button>
