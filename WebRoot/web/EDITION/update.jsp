	     ...
	     function AddRecord(){
	        ...
	        if(androidcontent==null||androidcontent==""){
	       	...
	       	if(ioscontent==null || ioscontent==""){
	       		$.messager.alert("错误","ios新功能介绍不能为空！");
	       		return;	       		
	       	}
...
// 	       	if(productimg2=="" || productimg2==null){
...
// 	       	}
			...
			$("#b").show();
       		...
       		setTimeout(function(){
       			var res="";
       			if(productimg1==null||trim(productimg1)==""){
       			  res = $('#addForm').SubmitForm("${ctx}/edition/tedition/update.action");
       			}else{
       			 res = $('#addForm').SubmitForm("<%=basePath%>/servlet/BBUpload?android="+android+"&androname="+androname+"&androidcontent="+androidcontent+"&ios="+ios+"&iosname="+iosname+"&ioscontent="+ioscontent+"&bbid="+bbid+"&iosurl="+iosurl);
       			}
   ...
   <div id="a">
		<table style="margin-top: 15px;width: 96%;" >
			...
			<tr align="right">
				...
				<td width="20%">
				<input class="form_text" type="hidden" name="edition.id" id="id"  value="${edition[0].id }">
				<input class="form_text"  name="edition.android" id="android"  value="${edition[0].android }"></td>
			</tr>
			<tr align="right">
				<th width="20%"><span style="color: red;">*</span>安卓版本名称：</th>
				<td width="20%"><input class="form_text"  name="edition.androname" id="androname"  value="${edition[0].androname }"></td>
			</tr>
			<tr align="right">
				<th width="20%"><span style="color: red;">*</span>安卓新功能介绍：</th>
				<td width="20%">
				<textarea  rows="3" cols="20"  name="edition.androidcontent" id="androidcontent"  value="">${edition[0].androidcontent }</textarea>
				</td>
			</tr>
			...
			<tr align="right">
				...
				<td width="20%" align="left"><input name="file" type="file" id="productimg1"  class="offset10 lf"  /></td>
			</tr>
			<tr align="right">
				<th width="20%"><span style="color: red;">*</span>ios版本号：</th>
				<td width="20%"><input class="form_text"  name="edition.ios" id="ios"  value="${edition[0].ios }"></td>
			</tr>
			<tr align="right">
				<th width="20%"><span style="color: red;">*</span>ios版本名称：</th>
				<td width="20%"><input class="form_text"  name="edition.iosname" id="iosname"  value="${edition[0].iosname }"></td>
			</tr>
			<tr align="right">
				<th width="20%"><span style="color: red;">*</span>ios新功能介绍：</th>
				<td width="20%">
				<textarea  rows="3" cols="20"  name="edition.ioscontent" id="ioscontent"  value="">${edition[0].ioscontent }</textarea>
				
				</td>
			</tr>
			
<!-- 			<tr align="right"> -->
<!-- 				<th width="20%"><span style="color: red;">*</span>ios apk：</th>		 -->
				
<!-- 				<td width="20%" align="left"><input name="file1" type="file" id="productimg2"  class="offset10 lf"  /></td> -->
<!-- 			</tr>	 -->
			<tr align="right">
				<th width="20%"><span style="color: red;">*</span>iosURL：</th>
				<td width="20%"><input class="form_text"  name="edition.iosURL" id="iosurl"  value="${edition[0].iosurl }"></td>
			</tr>
