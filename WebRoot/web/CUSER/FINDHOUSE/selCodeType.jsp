...
// 		 }
	  ...
	  TwoFrame.location.href= "${ctx}/web/CUSER/FINDHOUSE/content.jsp?isdel="+isdel+"&uid="+uid+"&type="+type+"&qu="+qu+"&price="+price+"&tese="+tese+"&mdid="+mdid+"&hid="+hid+"&area="+area+"&aid="+aid+"&realname="+realname+"&telephone="+telephone;
  }
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/CUSER/FINDHOUSE/content.jsp?uid=${param.uid}" frameborder="0" scrolling="no"></iframe>
</div>
