...
<script type="text/javascript">
  function searchByKey(){
	  ...
	  TwoFrame.location.href= "${ctx}/web/CUSER/USER/content.jsp?title="+encodeURI(title)+"&isdel="+isdel+"&status="+status+"&uid="+uid+"&realname="+realname;
  }
</script>
</head>
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/CUSER/USER/content.jsp" frameborder="0" scrolling="no"></iframe>
</div>
</body>
</html>