   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >		
			<tr>
				...
				<td width="30%">				
				<div class="lf salebd"><a href="#"  id="preview"><img id="imghead"  src="http://120.27.215.48:8081/df/${user[0].ico }" width="100" height="80" /></a></div>
				</td>				
			</tr> 
			<tr>
				<th width="20%"><span style="color: red;"></span>qq头像：</th>
				<td width="30%">				
				<div class="lf salebd"><a href="#"  id="preview"><img id="imghead"  src="http://120.27.215.48:8081/df/${user[0].qqico }" width="100" height="80" /></a></div>
				</td>
			...
			<tr>
				...
				<td width="30%">				
				<div class="lf salebd"><a href="#"  id="preview"><img id="imghead"  src="http://120.27.215.48:8081/df/${user[0].IdPiczheng }" width="100" height="80" /></a></div>
				</td>
			...
			<tr>
				...
				<td width="30%">				
				<div class="lf salebd"><a href="#"  id="preview"><img id="imghead"  src="http://120.27.215.48:8081/df/${user[0].IdPicfan }" width="100" height="80" /></a></div>
				</td>
