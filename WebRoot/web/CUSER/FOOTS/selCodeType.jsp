...
<script type="text/javascript">
  function searchByKey(){
	  ...
	  TwoFrame.location.href= "${ctx}/web/CUSER/FOOTS/content.jsp?isdel="+isdel+"&uid="+uid+"&status="+status+"&name="+name+"&realname="+realname+"&telephone="+telephone;
  }
...
<div style="position: absolute;top: 30px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/CUSER/FOOTS/content.jsp?uid=${param.uid}" frameborder="0" scrolling="no"></iframe>
</div>
