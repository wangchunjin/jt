  ...
  <head>
  	<script type="text/javascript">
	  	function add(){
	        ...
	        createSimpleWindow("addWindow","新增","${ctx}/web/CUSER/INSURANCE/addColor.jsp?currFrameId="+currFrameId+"&uid="+uid, 600,400);
	    }
	    function update(){
			...
			createSimpleWindow("eidtWindow","修改配置","${ctx}/carinsurance/tcarinsurance/findById.action?id="+rows[0].id+"&currFrameId="+currFrameId,600,400);
	  	...
	  	function del(){
			...
			parent.LeftFrame.TwoFrame.$.messager.confirm("提醒","确定要删除?",function(res){
	        	...
	        	if(res){
					var res = IntoActionByUrl("${ctx}/carinsurance/tcarinsurance/delete.action?id="+ids);
					//alert(res[0].result);
