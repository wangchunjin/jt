  ...
  <body class="NewWinClass">
   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >
			<tr id="aaa" >
				<th width="20%"><span style="color: red;"></span>活动广告图片：</th>
				<td width="30%">				
				<div class="lf salebd">				
				<a href="#"  id="preview"><img id="imghead"  src="../../../images/ic_pic_loading.png" width="NAN" height="100" /></a></div><br>
				</td>
			</tr>
			<tr id="bbb" >
			<th width="20%"><span style="color: red;"></th>
				...
				<input class="form_text" type="hidden"  name="adv.type" id="type"  value="1">				
				</td>
			</tr>
			<tr   >
			...
			<tr>
				<th width="20%"><span style="color: red;">*</span>活动广告内容状态：</th>
				<td width="20%">			
					<select class="form_text" name="adv.status" id="status" onchange="check()" style="width: 100%;">
						<option value="2">广告链接</option>
						<option value="1">广告文本</option>
					</select>
				</td>
			</tr>
			
			<tr id="ttt"  >
				<th width="20%"><span style="color: red;">*</span>活动广告内容(链接)：</th>
				<td width="20%"><input class="form_text"  name="adv.url" id="url"  value=""></td>
			</tr>			
			<tr id="hhh" style="display:none;">
			<th width="20%"><span style="color: red;">*</span>活动广告内容(文本)：</th>
       ...
       <input class="form_text" type="hidden"  name="adv.content" id="content"  value="">	
</form>
</div>
		<div class="BottomDiv">
