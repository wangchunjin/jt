  ...
  <body class="NewWinClass">
   ...
   <form method="post" action="" id="addForm" name="addForm">
		<table style="margin-top: 15px;width: 96%;" >
			<tr id="aaa" >
				<th width="20%"><span style="color: red;"></span>楼盘广告图片：</th>
				<td width="30%">				
			...
			<th width="20%"><span style="color: red;"></th>
				...
				<input class="form_text" type="hidden"  name="adv.l_id" id="lid"  value="${param.lid }">
				<input class="form_text" type="hidden"  name="adv.type" id="type"  value="3">
			...
			<tr>
				<th width="20%"><span style="color: red;">*</span>楼盘广告内容状态：</th>
				<td width="20%">			
			...
			<tr id="ttt"  >
				<th width="20%"><span style="color: red;">*</span>楼盘广告内容(链接)：</th>
				<td width="20%"><input class="form_text"  name="adv.url" id="url"  value=""></td>
			</tr>
			
			
			<tr id="hhh" style="display:none;">
			<th width="20%"><span style="color: red;">*</span>楼盘广告内容(文本)：</th>
