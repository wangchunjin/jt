...
<script type="text/javascript">
	...
	function UpdateRecord() {
		...
		if(servicephone==null || trim(servicephone)==""){
			$.messager.alert("错误","客服电话不能为空！");
			return;
		}
		
		//微信公众号名称
		var weixinname=$("#weixinname").val();
		if(weixinname==null || trim(weixinname)==""){
			$.messager.alert("错误","微信公众号不能为空！");
			return;
		}
...
//         	}
		...
		var res = $('#addForm').SubmitForm("${ctx}/about/tabout/update.action");
...
<!-- 				<td width="30%" align="left"> -->
				<input type="hidden" class="form_text"  name="about.id" id="id"  value="${about[0].id }">
...
<!-- 				</tr> -->
			...
			<tr id="hhh">
			<th width="10%" align="right"><span style="color: red;">*</span>平台简介：</th>
			
				<td>
					<textarea id="CONTENTT" name="CONTENTT" class="label_textarea"  style="height: 400px;width: 880px;" >${about[0].content }</textarea> 					   	  
				</td>
			</tr>
       </table>
       <input class="form_text" type="hidden"  name="about.content" id="content"  value="${about[0].content }">	
</form>
</div>
	<div class="BottomDiv">
		<epmis:button id="NewRecord" imageCss="icon-edit" value="确定" action="UpdateRecord()" datactrCode="aboutt_update.edit" ></epmis:button> 
<!-- 		<a -->
