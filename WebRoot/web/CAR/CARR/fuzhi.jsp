...
// 	        }
	        ...
	        var res = $('#addForm').SubmitForm("${ctx}/car/tcar/save.action?fuzhi=19491001");
   ...
   <form method="post" action="" id="addForm" name="addForm">
		...
		<tr align="right">
			...
			<tr align="right">
				...
				<th><div class="lf salebd"><a href="#"  id="preview"><img id="imghead" name="car.pic"  src="../../../images/ic_pic_loading.png" width="100" height="80" /></a></div><br></th>
				<td width="20%">
			...
			<tr align="right">
				...
				<th><div class="lf salebd"><a href="#"  id="preview"><img id="imghead1" name="car.ico"   src="../../../images/ic_pic_loading.png" width="100" height="80" /></a></div><br></th>
...
<!-- 			</tr> -->
			<tr align="right">
				<th width="5%"><span style="color: red;">*</span>代办服务费(元)：</th>
...
<!-- 			</tr> -->
			...
			<tr align="right">
				...
				<input class="form_text"  name="car.stock" id="stock"  value="0"></td>
			</tr>
			<tr align="right">
...
<!-- 				</td> -->
			...
			<tr align="right">
				...
				<td width="10%">
				   ...
				   <input name="file2" style="width: 100%;" type="file"  id="car_vedio"  >
				
				</td>
				
				<input class="form_text" type="hidden"  name="car.buy_car_flow" id="buy_car_flow"  value="-">
			</tr>
			<tr style="display: none;">
