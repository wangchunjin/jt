...
<script type="text/javascript">
  function searchByKey(){
  		 var nid = '${param.nid}'; 	 
		 var isdel = $("#isdel").val();	  
	  TwoFrame.location.href= "${ctx}/web/NAIRES/OPTIONS/content.jsp?isdel="+isdel+"&nid="+nid;
  }
...
<div style="position: absolute;top: 0px;bottom: 0;left: 0;right: 0;">
	<iframe name="TwoFrame" width="100%" height="100%" id="TwoFrame" noresize="noresize" src="${ctx}/web/NAIRES/OPTIONS/content.jsp?nid=${param.nid}" frameborder="0" scrolling="no"></iframe>
</div>
